...
export default function DashboardMockup() {
  return (
    <div className="relative w-full max-w-lg mx-auto lg:mx-0">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(65,182,196,0.15)_0%,transparent_70%)] blur-2xl pointer-events-none" />
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-lg bg-navy-900/60 border border-white/5 p-3">
              <div className="text-[10px] text-navy-400 uppercase tracking-wider">Risk Score</div>
            ...
            <div className="rounded-lg bg-navy-900/60 border border-white/5 p-3">
              <div className="text-[10px] text-navy-400 uppercase tracking-wider">Properties</div>
            ...
            <div className="rounded-lg bg-navy-900/60 border border-white/5 p-3">
              <div className="text-[10px] text-navy-400 uppercase tracking-wider">ESG Avg</div>
          ...
          <div className="rounded-lg bg-navy-900/60 border border-white/5 p-3">
            <div className="flex items-center justify-between mb-3">
              <span className="text-[10px] text-navy-400 uppercase tracking-wider">Portfolio Risk Trend</span>
          ...
          {/* Risk breakdown bars */}
          <div className="rounded-lg bg-navy-900/60 border border-white/5 p-3">
            <div className="text-[10px] text-navy-400 uppercase tracking-wider mb-3">Risk Breakdown</div>
